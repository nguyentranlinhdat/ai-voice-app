...
export default function DemoSection() {
  ...
  const multilingualSamples = [
    ...
    },
    {
      id: "vietnamese",
      language: "Vietnamese 🇻🇳",
      text: "Xin chào! Tôi tên là Nga",
      audioUrl: "/audio/vietnamese.wav",
    },
  ];
    ...
    if (audio) {
      audio
        ...
        .catch((error) => {
          ...
          alert(
            "Unable to play audio. Please check the audio file or try generating your speech in the dashboard!",
          );
        });
      audio.onended = () => {
        setPlayingId(null);
    ...
    <section className="bg-gradient-to-br from-indigo-50/50 to-cyan-50/30 py-20 sm:py-32">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-16">
          ...
          <Card className="borders-slate-200 overflow-hidden">
        ...
        <div className="mt-12 text-center">
          ...
          <Link href="/dashboard">
            <Button
              size="lg"
              className="cursor-pointer gap-2 bg-gradient-to-r from-purple-500 to-indigo-600 hover:from-purple-600 hover:to-indigo-700"
            >
