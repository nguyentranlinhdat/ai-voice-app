  ...
  return (
    <Card className="shadow-lg">
      <CardContent className="p-2 sm:p-3">
        <div className="md-2 flex items-start justify-between">
          <div>
        ...
        <div className="space-y-3">
          <textarea
            ...
            placeholder="Type or paste text here... Maximum 500 characters."
            maxLength={500}
            rows={8}
          ...
          {currentAudio && (
            <div className="bg-gradient-to rounded-lg border border-blue-200 from-blue-50 to-purple-50 p-3">
