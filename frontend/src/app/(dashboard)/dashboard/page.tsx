          ...
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            ...
            <Card className="relative overflow-hidden">
              ...
              <CardContent>
                ...
                <p className="text-muted-foreground text-xs">Account create</p>
              </CardContent>
            </Card>
          </div>
          <Card>
            <CardHeader>
              <CardTitle className="flex items-center gap-2">
                <Sparkles className="text-primary h-5" />
                Quick Actions
              </CardTitle>
            </CardHeader>
            <CardContent>
              <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
                <Button
                  ...
                  className="group h-auto flex-col gap-2 bg-purple-600 hover:bg-purple-700"
                >
                  <Mic className="h-8 w-8 transition-transform group-hover:scale-110"></Mic>
                ...
                <Button
                  ...
                  variant="outline"
                  className="group hover:bg-muted-foreground h-auto flex-col gap-2 p-6"
                >
                  <Music className="h-8 w-8 transition-transform group-hover:scale-110"></Music>
                  <div className="text-center">
          ...
          <Card>
            <CardHeader className="flex flex-row items-center justify-between">
              ...
              {audioProjects.length > 0 && (
                ...
                >
                  View All <ArrowRight className="ml-1 h-4 w-4"></ArrowRight>
                </Button>
              )}
            </CardHeader>
            <CardContent>
              {audioProjects.length === 0 ? (
                <>
                  ...
                  >
                    <Mic className="h-4 w-4"></Mic>Create Your First Audio
                  </Button>
                </>
              ) : (
                <>
