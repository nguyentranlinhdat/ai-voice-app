  ...
  const testimonials = [
    {
      ...
      role: "Voice Actor",
      content:
        "This tool has revolutionized my workflow. Voice cloning the used to take hours now takes minutes!",
      rating: 5,
    },
    {
      name: "Marcus Johnson",
    ...
    },
    {
      ...
      content:
        "Nice app! The voice variety is incredible. I can create content in multiple languages with authentic accents.",
      rating: 5,
    },
  ];
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex h-16 items-center justify-between">
            <div className="flex items-center gap-2">
              <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-gradient-to-br from-purple-500 to-indigo-500 shadow-lg">
                <Sparkles className="h-5 w-5 text-white" />
              </div>
              <span className="bg-gradient-to-r from-purple-500 to-indigo-600 bg-clip-text text-xl font-bold text-transparent">
                AI Voice App
              </span>
            </div>
            ...
            <div className="flex items-center gap-3">
              <Link href="/auth/sign-in">
                <Button
                  variant="ghost"
                  size="sm"
                  className="cursor-pointer text-slate-600 transition hover:bg-slate-100 hover:text-indigo-600"
                >
                  Sign In
                </Button>
              </Link>
              <Link href="/dashboard">
                <Button
                  size="sm"
                  className="cursor-pointer bg-gradient-to-r from-indigo-500 to-purple-600 text-white shadow-md transition hover:from-indigo-600 hover:to-purple-700"
                >
                  Try Free
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-4xl text-center">
            <div className="mb-8 inline-flex items-center gap-2 rounded-full border border-indigo-200/60 bg-indigo-100/30 px-4 py-2 text-sm">
              <Sparkles className="h-4 w-5 text-indigo-600"></Sparkles>
              <span className="font-medium text-indigo-700">
                Powered bg Advanced AI
              </span>
            </div>
          ...
          <div className="mt-16 text-center">
            <p className="mb-8 text-sm text-slate-500">
              Trusted by thousand of creators worldwide
            </p>
            <div className="optional-80 grid grid-cols-2 items-center justify-center gap-6 sm:grid-cols-5">
            ...
            {features.map((features, index) => (
              ...
              >
                <CardContent className="p-6">
                  <div
                    className={`${features.bgColor} mb-4 inline-flex items-center justify-center rounded-lg p-3 ${features.color}`}
                  >
                    {features.icon}
                  </div>
                ...
                <div className="absolute inset-0 bg-gradient-to-r from-blue-500/0 to-blue-500/5 opacity-0 transition-opacity group-hover:opacity-100"></div>
              </Card>
            ))}
          </div>
        </div>
            ...
            {[
              ...
              <div key={index} className="relative">
                <div className="mb-4 flex items-center">
                  ...
                  {index < 2 && (
                    <div className="ml-4 hidden h-0.5 w-full bg-slate-300 md:block"></div>
                  )}
                </div>
      ...
      <section id="testimonials" className="bg-white py-20 sm:py-32">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mx-auto mb-16 max-w-2xl text-center">
            ...
            <p className="mt-4 text-lg text-slate-600">
              See what our users are saying about AI Voice App
            </p>
          </div>
          ...
          <div className="mx-auto max-w-lg">
            <Card className="relative overflow-hidden border-2 border-indigo-300 bg-white/70 backdrop-blur-sm">
              ...
              <CardContent className="p-8">
                ...
                <Link href="/dashboard">
                  <Button
                    className="w-full cursor-pointer gap-2 bg-gradient-to-r from-purple-500 to-indigo-600 hover:from-purple-600 hover:to-indigo-700"
                    size="lg"
                  >
          ...
          <div className="mx-auto max-w-2xl text-center">
            ...
            <div className="mt-8 flex flex-col gap-4 sm:flex-row sm:justify-center">
              <Link href="/dashboard">
                <Button
                  size="lg"
                  className="cursor-pointer gap-2 bg-gradient-to-r from-purple-500 to-indigo-600 px-8 py-6 text-base hover:from-purple-600 hover:to-indigo-700"
                >
            ...
            <div className="grid gap-8 md:grid-cols-4">
              ...
              <div>
                ...
                <ul className="space-y-3 text-sm text-slate-600">
                  <li>
                    <Link
                      href="#features"
                      className="transitions-colors hover:text-indigo-600"
                    >
                      Features
                    </Link>
                  </li>
              ...
              <div>
                ...
                <ul className="space-y-3 text-sm text-slate-600">
                  <li>
                    <Link
                      href="https://github.com/nguyentranlinhdat"
                      className="transitions-colors hover:text-indigo-600"
                    >
                      Contact
                    </Link>
