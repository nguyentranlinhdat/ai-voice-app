...
app = modal.App("ai-voice-app-datlinh02")
...
s3_secret = modal.Secret.from_name("ai-voice-app-aws-secret")
...
@app.cls(
    ...
    volumes={
        ...
        "/s3-mount": modal.CloudBucketMount("ai-voice-app-datlinh02", secret=s3_secret)
    },
